...
Mario.MapState.prototype.Draw = function(context) {
    ...
    this.Font.Strings[1] = { String: "Level: " + (this.WorldNumber + 1), X: 256, Y: 4 };
    this.FontShadow.Strings[1] = { String: "Level: " + (this.WorldNumber + 1), X: 257, Y: 5 };
