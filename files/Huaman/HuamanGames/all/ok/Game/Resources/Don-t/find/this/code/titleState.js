...
Mario.TitleState.prototype.Enter = function() {
    ...
    this.title.X = 0, this.title.Y = 400;
    ...
    this.font.Strings[1] = { String: "Press S to Start", X: 96, Y: 120 };
    this.font.Strings[0] = { String: "Game by Huaman", X: 96, Y: 200 };
    this.font.Strings[2] = { String: "Difficulty Easy", X: 96, Y: 220 };
	...
	Mario.HackedMarioCharacter = new Mario.Character();
...
Mario.TitleState.prototype.Draw = function(context) {
    ...
    context.drawImage(Enjine.Resources.Images["title"], 0, 140);
...
Mario.TitleState.prototype.CheckForChange = function(context) {
    ...
    if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.V)) {
    Mario.Character.Lives++;
    }
