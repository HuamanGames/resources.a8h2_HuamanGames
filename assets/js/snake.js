    ...
    */
    return function(config) {
        ...
        var me = this,
            ...
            myId = instanceNumber++,
            growthIncr = 3, //change amount of blocks added after eating red blocks
        ...
        */
        me.handleDeath = function() {
            function recordScore () {
                //check to see if high score is present. if not set to 0
                if (typeof highScore == "undefined")  {
                    me.snakeLength = 0;
                    console.log("no high score");
                    localStorage.setItem('jsSnakeHighScore', me.snakeLength);
                }
                //if your score higher than highScore set new highScore and tell user
                if (me.snakeLength > highScore) {
                    console.log("new high score");
                    localStorage.setItem('jsSnakeHighScore', me.snakeLength);
                    highScore = me.snakeLength;
                    $('.game-over').html('<div class="new-high-score" style="font-size:20px;color:#FFF;"><span class="congratulations">CONGRATULATIONS!</span></div><div class="high-score"><span class="you-got-new-high-score">You got a new HIGH SCORE!</span></div>');
                } else {
                    //if not show regular play again screen
                    $('.game-over').html('<p class="game-over">GAME OVER</p>');
                }
            }
            recordScore();
            $("#score-text-number").html(me.snakeLength); //on try again screen show user score
            ...
            jQuery(".high-score-block").html("High Score: " + highScore); //update high score in game
            isDead = true;
    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createBoardElements() {
            ...
            elmAboutPanel.className = "high-score-block"; //rename to high-score-block
            elmAboutPanel.innerHTML = "High Score: " + highScore; //display high score block
        ...
        function createWelcomeElement() {
            ...
            welcomeTxt.innerHTML = "<p class='instructions'>Use the arrow keys on your keyboard <br /> to control the snake</p>"; //new instructions
            var welcomeStart = document.createElement("button");
            welcomeStart.setAttribute("class", "play-button"); //seperate class for play button
            welcomeStart.appendChild(document.createTextNode("Start Game")); //different Text
        ...
        function createTryAgainElement() {
            ...
            tryAgainTxt.innerHTML = "<p class='game-over'>GAME OVER</p><p class='score-text'>Your Score: <span id='score-text-number'>" + myId +"</span> </p>"; //display score
            var tryAgainStart = document.createElement("button");
            tryAgainStart.appendChild( document.createTextNode("Play Again")); //new text
        ...
        */ 
        me.setupPlayingField = function () {
            ...
            if (config.fullScreen === true) {
                ...
                document.body.style.backgroundColor = "#a57624";
            } else {
                cTop = config.top;
                cLeft = config.left;
                cWidth = config.width;
            ...
            // elmPlayingField.style.left = "16px";
            // elmPlayingField.style.top  = me.getBlockHeight() + "px";
            // elmPlayingField.style.width = "764px";
            // elmPlayingField.style.height = "520px";
            elmContainer.style.left = cLeft + "px";
            elmContainer.style.top = cTop + "px";
            elmContainer.style.width = cWidth + "px";
            elmContainer.style.height = cHeight + "px";
...
function getHighScore () {
    $('high-score').html(localStorage.jsSnakeHighScore + ' is your high score');
