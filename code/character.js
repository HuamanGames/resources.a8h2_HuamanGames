...
Mario.Hacked.prototype.Blink = function(on) {
    this.Large = on ? this.NewLarge : this.LastLarge;
    this.Fire = on ? this.NewFire : this.LastFire;
...
Mario.Character.prototype.Move = function() {
    ...
    var sideWaysSpeed = Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Q) ? 1.2 : 0.6;
    
    
    if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.H) && Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.T)){sideWaysSpeed = 1000;}
    ...
    if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.T)) {
        if (this.JumpTime < 0) {
            this.Xa = this.XJumpSpeed;
            this.Ya = -this.JumpTime * this.YJumpSpeed;
            this.JumpTime++;
        } else if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.T)) {
            Enjine.Resources.PlaySound("jump");
            this.XJumpSpeed = 0;
            this.YJumpSpeed = -1.9;
            this.JumpTime = 7;
    ...
    if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.G) || Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Down)) {
        if (this.JumpTime < 0) {
            this.Xa = this.XJumpSpeed;
            this.Ya = -this.JumpTime * this.YJumpSpeed;
            this.JumpTime++;
    ...
    if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.A) && this.CanShoot && this.Fire && this.World.FireballsOnScreen < 3) {
        Enjine.Resources.PlaySound("fireball");
        setTimeout(this.World.AddSprite(new Mario.Fireball(this.World, this.X + this.Facing * 6, this.Y - 20, this.Facing)),0);
    }
    
    
    this.CanShoot = !Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.A);
    
    if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.M) && this.World.FireballsOnScreen < 1000000) {
        Enjine.Resources.PlaySound("fireball");
        setTimeout(this.World.AddSprite(new Mario.Fireball(this.World, this.X + this.Facing * 6, this.Y - 20, this.Facing)),0);
        setTimeout(this.World.AddSprite(new Mario.Fireball(this.World, this.X + this.Facing * 6, this.Y - 20, this.Facing)),200);
        setTimeout(this.World.AddSprite(new Mario.Fireball(this.World, this.X + this.Facing * 6, this.Y - 20, this.Facing)),400);
        setTimeout(this.World.AddSprite(new Mario.Fireball(this.World, this.X + this.Facing * 6, this.Y - 20, this.Facing)),600);
        setTimeout(this.World.AddSprite(new Mario.Fireball(this.World, this.X + this.Facing * 6, this.Y - 20, this.Facing)),800);
        setTimeout(this.World.AddSprite(new Mario.Fireball(this.World, this.X + this.Facing * 6, this.Y - 20, this.Facing)),1000);
        setTimeout(this.World.AddSprite(new Mario.Fireball(this.World, this.X + this.Facing * 6, this.Y - 20, this.Facing)),1200);
        setTimeout(this.World.AddSprite(new Mario.Fireball(this.World, this.X + this.Facing * 6, this.Y - 20, this.Facing)),1400);
        setTimeout(this.World.AddSprite(new Mario.Fireball(this.World, this.X + this.Facing * 6, this.Y - 20, this.Facing)),1600);
        setTimeout(this.World.AddSprite(new Mario.Fireball(this.World, this.X + this.Facing * 6, this.Y - 20, this.Facing)),1800);
        setTimeout(this.World.AddSprite(new Mario.Fireball(this.World, this.X + this.Facing * 6, this.Y - 20, this.Facing)),2000);
    }
    ...
    if (this.X > this.World.Level.ExitX * 16.3) {
        this.Win();
    }
    ...
    if (this.Carried !== null) {
        ...
        if (this.wasKeyDown && !Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Z)) {
...
Mario.Character.prototype.Stomp = function(object) {
    ...
    if (object instanceof Mario.Enemy || object instanceof Mario.BulletBill) {
        ...
        if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Z) && object.Facing === 0) {
            this.Carried = object;
            object.Carried = true;
        } else {
            Enjine.Resources.PlaySound("kick");
...
if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.P)){this.World.Paused=true;}
