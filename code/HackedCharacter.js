/**
	...
	Mario.HackedCharacter
*/

Mario.HackedCharacter = function() {
...
Mario.HackedCharacter.prototype = new Mario.NotchSprite(null);
Mario.Hacked.prototype = new Mario.NotchSprite(null);


Mario.HackedCharacter.prototype.Initialize = function(world) {
    this.World = world;
    this.X = 32;
    this.Y = 0;
	this.PowerUpTime = 0;
...
Mario.Hacked.prototype.Initialize = function(world) {
    this.World = world;
    this.X = 32;
    this.Y = 0;
    this.PowerUpTime = 0;
...
Mario.HackedCharacter.prototype.SetLarge = function(large, fire) {
    if (fire) {
        large = true;
    }
    if (!large) {
...
Mario.Hacked.prototype.SetLarge = function(large, fire) {
    if (fire) {
        large = true;
    }
    if (!large) {
...
Mario.HackedCharacter.prototype.Blink = function(on) {
...
Mario.HackedCharacter.prototype.Move = function() {
    if (this.WinTime > 0) {
        this.WinTime++;
        this.Xa = 0;
        this.Ya = 0;
...
Mario.Hacked.prototype.Move = function() {
    if (this.WinTime > 0) {
        this.WinTime++;
        this.Xa = 0;
        this.Ya = 0;
...
Mario.HackedCharacter.prototype.CalcPic = function() {
    var runFrame = 0, i = 0;
...
Mario.HackedCharacter.prototype.SubMove = function(xa, ya) {
    var collide = false;
...
Mario.Hacked.prototype.SubMove = function(xa, ya) {
    var collide = false;
...
Mario.HackedCharacter.prototype.IsBlocking = function(x, y, xa, ya) {
...
Mario.Hacked.prototype.IsBlocking = function(x, y, xa, ya) {
    var blocking = false, block = 0, xx = 0, yy = 0;
...
Mario.HackedCharacter.prototype.Stomp = function(object) {
    var targetY = 0;
...
Mario.Hacked.prototype.Stomp = function(object) {
    var targetY = 0;
...
Mario.HackedCharacter.prototype.GetHurt = function() {
    if (this.DeathTime > 0 || this.World.Paused) {
        return;
    }
    if (this.InvulnerableTime > 0) {
...
Mario.Hacked.prototype.GetHurt = function() {
    if (this.DeathTime > 0 || this.World.Paused) {
        return;
    }
    if (this.InvulnerableTime > 0) {
...
Mario.HackedCharacter.prototype.Win = function() {
...
Mario.Hacked.prototype.Win = function() {
    this.XDeathPos = this.X | 0;
    this.YDeathPos = this.Y | 0;
    this.World.Paused = true;
    this.WinTime = 1;
...
Mario.HackedCharacter.prototype.Die = function() {
    this.XDeathPos = this.X | 0;
    this.YDeathPos = this.Y | 0;
    this.World.Paused = true;
    this.DeathTime = 1;
...
Mario.Hacked.prototype.Die = function() {
    this.XDeathPos = this.X | 0;
    this.YDeathPos = this.Y | 0;
    this.World.Paused = true;
    this.DeathTime = 1;
...
Mario.HackedCharacter.prototype.GetFlower = function() {
    if (this.DeathTime > 0 && this.World.Paused) {
        return;
    }
...
Mario.Hacked.prototype.GetFlower = function() {
    if (this.DeathTime > 0 && this.World.Paused) {
        return;
    }
...
Mario.HackedCharacter.prototype.GetMushroom = function() {
    if (this.DeathTime > 0 && this.World.Paused) {
        return;
    }
...
Mario.Hacked.prototype.GetMushroom = function() {
    if (this.DeathTime > 0 && this.World.Paused) {
        return;
    }
...
Mario.HackedCharacter.prototype.Kick = function(shell) {
    if (this.DeathTime > 0 && this.World.Paused) {
        return;
    }
...
Mario.Hacked.prototype.Kick = function(shell) {
    if (this.DeathTime > 0 && this.World.Paused) {
        return;
    }
...
Mario.HackedCharacter.prototype.Get1Up = function() {
...
Mario.Hacked.prototype.Get1Up = function() {
    Enjine.Resources.PlaySound("1up");
    this.Lives++;
    if (this.Lives === 99) {
        this.Lives = 99;
...
Mario.HackedCharacter.prototype.GetCoin = function() {
    this.Coins++;
    if (this.Coins === 100) {
        this.Coins = 0;
        this.Get1Up();
...
Mario.Hacked.prototype.GetCoin = function() {
    this.Coins++;
    if (this.Coins === 100) {
        this.Coins = 0;
        this.Get1Up();
