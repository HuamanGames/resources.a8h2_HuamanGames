...
HTMLActuator.prototype.message = function (won) {
  ...
  var message = won ? "You win Huaman's Game!" : "Sorry, Huaman rebelled. Game over!";
...
HTMLActuator.prototype.scoreTweetButton = function () {
  ...
  var text = "I scored " + this.score + "-" + caption(this.level).toUpperCase() + " at 2048-PANTONE #2048game";
